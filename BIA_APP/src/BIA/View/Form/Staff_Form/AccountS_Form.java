package BIA.View.Form.Staff_Form;

import BIA.Controller.Service.ServiceStaff;
import BIA.Model.ModelNhanVien;
import BIA.Model.ModelNguoiDung;
import BIA.View.Dialog.MS_ChangePassword;
import BIA.View.Dialog.MS_ConfirmRename;
import BIA.View.Main_Frame.Main_Customer_Frame;
import BIA.View.Main_Frame.Main_Staff_Frame;
...
public class AccountS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pic = new BIA.View.Swing.ImageAvatar();
        lbmaNV = new javax.swing.JLabel();
        txtngVL = new BIA.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new BIA.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new BIA.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new BIA.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new BIA.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new BIA.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new BIA.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new BIA.View.Swing.MyTextField();
        txtSDT = new BIA.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new BIA.View.Swing.MyTextField();
        ...
        cmdDMK.setBackground(new java.awt.Color(0, 204, 204));
    ...
    private BIA.View.Swing.Button cmdDMK;
    ...
    private BIA.View.Swing.ImageAvatar pic;
    private javax.swing.JLabel titleKH;
    private javax.swing.JLabel titleND;
    private BIA.View.Swing.MyTextField txtCvu;
    private BIA.View.Swing.MyTextField txtMaNQL;
    private BIA.View.Swing.MyTextField txtSDT;
    private BIA.View.Swing.MyTextField txtemail;
    private BIA.View.Swing.MyTextField txtmaNV;
    private BIA.View.Swing.MyPasswordField txtmatkhau;
    private BIA.View.Swing.MyTextField txtngVL;
    private BIA.View.Swing.MyTextField txtrole;
    private BIA.View.Swing.MyTextField txttenNV;
