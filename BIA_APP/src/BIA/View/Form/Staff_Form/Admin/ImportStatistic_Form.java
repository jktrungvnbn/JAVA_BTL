...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    public void initTable() {
        try {
            ...
            for (ModelPNK data : list) {
                tablePNK.addRow(new Object[] { data.getIdNK(), data.getIdNV(), data.getNgayNK(),
    ...
    private void initComponents() {
        ...
        tablePNK = new BIA.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTNK = new BIA.View.Swing.Button();
        ...
        cmdCTNK.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            workbook.easy_WriteXLSXFile(
                    ".\\src\\ExportFile_Excel\\DanhsachPNK_" + simpleDateFormat.format(new Date()) + ".xlsx");
    ...
    private BIA.View.Swing.Button cmdCTNK;
    ...
    private BIA.View.Swing.Table tablePNK;
