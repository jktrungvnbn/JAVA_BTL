...
public class MenuManagement_Form extends javax.swing.JPanel {
    ...
    public void initTable() {
        try {
            ...
            for (ModelMonAn data : list) {
                tableMA.addRow(new Object[] { data.getId(), data.getTitle(), df.format(data.getValue()) + "đ",
                        data.getType(), data.getState() });
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        tableMA = new BIA.View.Swing.Table();
    ...
    private BIA.View.Swing.Table tableMA;
