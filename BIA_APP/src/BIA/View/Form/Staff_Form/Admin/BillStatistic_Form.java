...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    public void initTable() {
        try {
            ...
            for (ModelHoaDon data : list) {
                tableHD.addRow(new Object[] { data.getIdHoaDon(), data.getIdKH(), data.getIdBan(), data.getNgayHD(),
                        df.format(data.getTienMonAn()) + "đ", df.format(data.getTienGiam()) + "đ",
    ...
    private void initComponents() {
        ...
        txtprofit = new BIA.View.Swing.MyTextField();
        lbCus = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableHD = new BIA.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTHD = new BIA.View.Swing.Button();
        cmdExcel = new BIA.View.Swing.Button();
        ...
        cmdCTHD.setBackground(new java.awt.Color(0, 153, 153));
        ...
        cmdExcel.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            workbook.easy_WriteXLSXFile(
                    ".\\src\\ExportFile_Excel\\DanhsachHoaDon_" + simpleDateFormat.format(new Date()) + ".xlsx");
            File file = new File(
                    "src\\ExportFile_Excel\\DanhsachHoaDon_" + simpleDateFormat.format(new Date()) + ".xlsx");
    ...
    private BIA.View.Swing.Button cmdCTHD;
    private BIA.View.Swing.Button cmdExcel;
    ...
    private BIA.View.Swing.Table tableHD;
    private BIA.View.Swing.MyTextField txtSearch;
    private BIA.View.Swing.MyTextField txtprofit;
