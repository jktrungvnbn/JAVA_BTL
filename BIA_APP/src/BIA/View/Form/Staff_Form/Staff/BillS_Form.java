...
import BIA.View.Dialog.MS_PaymentSuccess;
import BIA.View.Dialog.MS_Success;
import BIA.View.Form.MainForm;
import BIA.View.Main_Frame.Main_Admin_Frame;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    public void initTable() {
        try {
            ...
            for (ModelCTHD data : cthd) {
                tableCTHD.addRow(
                        new Object[] { data.getTenMonAn(), data.getSoluong(), df.format(data.getThanhTien()) + "d" });
            }
    ...
    private void initComponents() {
        ...
        bg = new BIA.View.Swing.PanelRound();
        ...
        txtidHD = new BIA.View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new BIA.View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new BIA.View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new BIA.View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new BIA.View.Swing.MyTextField();
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new BIA.View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new BIA.View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new BIA.View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new BIA.View.Swing.MyTextField();
        ...
        cmdExportBill.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmdOKActionPerformed
        try {
            // Khi NV bấm xác nhận thanh toán, thay đổi trạng thái hóa đơn từ Chưa
            // thanh toán thành đã thanh toán
    ...
    private BIA.View.Swing.PanelRound bg;
    private BIA.View.Swing.ButtonOutLine cmdCancel;
    private BIA.View.Swing.Button cmdExportBill;
    ...
    private BIA.View.Swing.Table tableCTHD;
    private BIA.View.Swing.MyTextField txtTienKH;
    private BIA.View.Swing.MyTextField txtTiengiam;
    private BIA.View.Swing.MyTextField txtTienmonan;
    private BIA.View.Swing.MyTextField txtTientra;
    private BIA.View.Swing.MyTextField txtTongtien;
    private BIA.View.Swing.MyTextField txtidHD;
    private BIA.View.Swing.MyTextField txtidKH;
