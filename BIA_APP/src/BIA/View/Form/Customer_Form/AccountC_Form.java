...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new BIA.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new BIA.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new BIA.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new BIA.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new BIA.View.Swing.MyTextField();
    ...
    private BIA.View.Swing.MyTextField txtdiemtl;
    private BIA.View.Swing.MyTextField txtdso;
    private BIA.View.Swing.MyTextField txtemail;
    private BIA.View.Swing.MyTextField txtmaKH;
    private BIA.View.Swing.MyPasswordField txtmatkhau;
    private BIA.View.Swing.MyTextField txtngayTG;
    private BIA.View.Swing.MyTextField txtrole;
    private BIA.View.Swing.MyTextField txttenKH;
