...
public class Bill_Form extends javax.swing.JPanel {
    ...
    public void initTable() {
        try {
            ...
            for (ModelHoaDon data : list) {
                tableHD.addRow(new Object[] { data.getIdHoaDon(), data.getNgayHD(),
                        df.format(data.getTienMonAn()) + "đ", data.getCode_voucher(),
                        df.format(data.getTienGiam()) + "đ", df.format(data.getTongtien()) + "đ" });
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        txtPoint = new BIA.View.Swing.MyTextField();
        ...
        cbbox.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Tất cả", "Dưới 1.000.000đ", "Từ 1 đến 5.000.000đ", "Trên 5.000.000đ" }));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(cbbox, javax.swing.GroupLayout.PREFERRED_SIZE, 176,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lbDso, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addComponent(jSeparator2, javax.swing.GroupLayout.PREFERRED_SIZE, 1,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(lbBill, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(cbbox, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private BIA.View.Swing.MyTextField txtPoint;
