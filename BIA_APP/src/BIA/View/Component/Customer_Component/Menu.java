...
import BIA.View.Swing.MenuAnimation;
import BIA.View.Swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/astrology.png")),
                "Menu - Zodiac Concept", "Aries - Bạch Dương", "Taurus - Kim Ngưu", "Gemini - Song Tử",
                "Cancer - Cự Giải",
                "Leo - Sư Tử", "Virgo - Xử Nữ", "Libra - Thiên Bình", "Scorpio - Bọ Cạp", "Sagittarius - Nhân Mã",
                "Capricorn - Ma Kết", "Aquarius - Bảo Bình", "Pisces - Song Ngư"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/table.png")), "Đặt bàn", "Tầng 1",
                "Tầng 2", "Tầng 3"));
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/invoice.png")),
                "Lịch sử hóa đơn"));
