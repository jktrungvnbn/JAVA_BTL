...
public class MS_ConfirmOrderFood extends javax.swing.JDialog {
    ...
    public void ConfirmOrder(ModelMonAn monan, int soluong, int ID_HoaDon) {
        ...
        lbMessage
                .setText("Bạn có chắc đặt món (" + monan.getTitle() + ") với số lượng " + soluong + " không ?");
                        ...
                        .addGroup(panelRound1Layout.createSequentialGroup()
                                .addGroup(
                                        panelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(panelRound1Layout.createSequentialGroup()
                                                        .addGap(115, 115, 115)
                                                        .addComponent(lbTotal, javax.swing.GroupLayout.PREFERRED_SIZE,
                ...
                panelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelRound1Layout.createSequentialGroup()
                                ...
                                .addGroup(panelRound1Layout
                                        ...
                                        .addComponent(cmdCancel, javax.swing.GroupLayout.DEFAULT_SIZE, 34,
                                                Short.MAX_VALUE))
                                .addGap(30, 30, 30)));
